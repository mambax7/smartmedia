<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_SMARTMEDIA_HELP_HEADER}>

    <h4 class="odd">Description</h4>

    <p class="even">SmartMedia is a XOOPS 2 module that let you manage a collection of multimedia clips, grouped by categories and folders.<br /> <br />
        </p>
