...
/**
* $Id: myblocksadmin.php,v 1.1 2005/05/13 18:21:55 malanciault Exp $
* Module: SmartMedia
...
function list_blocks()
{
    ...
    echo "<img id='toptableicon' src=" . XOOPS_URL . "/modules/" . $xoopsModule->dirname() . "/images/icon/close12.gif alt='' /></a>&nbsp;" . _AM_SMEDIA_BLOCKS . "</h3>";
    echo "<div id='toptable'>";
    echo "<span style=\"color: #567; margin: 3px 0 12px 0; font-size: small; display: block; \">" . _AM_SMEDIA_BLOCKSTXT . "</span>";
