    ...
    public function getTabs($browser = '')
    {
        ...
        foreach ($this->_tabs_text as $tab_text) {
            ...
            foreach ($subtabs_text as $subtab_text) {
                ...
                if ($subtab['id'] > 1) {
                    if ($ie) {
                        $subtab['arrow_left'] = "<a href=\" javascript:;\"  class=\"suiv_lay\" onclick=\"show('layer" . $subtab['id_text_previous'] . "'),hide('layer" . $subtab['id_text'] . "')\"><img src=\"" . SMARTMEDIA_IMAGE_URL . '400d_lay_flechg.gif" width="10" height="11" border="0"></a>';
                        $subtab['previous']   = "<span class=\"suiv_lay2\" onclick=\"show('layer" . $subtab['id_text_previous'] . "'),hide('layer" . $subtab['id_text'] . "')\">Précédent</span>";
                    } else {
                        $subtab['arrow_left'] = '<img src="' . SMARTMEDIA_IMAGE_URL . "400d_lay_flechg.gif\" onclick=\"show('layer" . $subtab['id_text_previous'] . "'),hide('layer" . $subtab['id_text'] . "')\" width=\"10\" height=\"11\" border=\"0\" class=\"curseur\">";
                ...
                if ($subtab['id'] < $tab['count']) {
                    if ($ie) {
                        ...
                        $subtab['arrow_right'] = '<img src="' . SMARTMEDIA_IMAGE_URL . "400d_lay_flechd.gif\" onclick=\"show('layer" . $subtab['id_text_next'] . "'),hide('layer" . $subtab['id_text'] . "')\" width=\"10\" height=\"11\"  border=\"0\" class=\"curseur\">";
                    } else {
                        $subtab['next']        = "<a href=\" javascript:;\" class=\"suiv_lay\" onclick=\"show('layer" . $subtab['id_text_next'] . "'),hide('layer" . $subtab['id_text'] . "')\">Suivant</a>";
                        $subtab['arrow_right'] = "<a href=\" javascript:;\" class=\"suiv_lay\" onclick=\"show('layer" . $subtab['id_text_next'] . "'),hide('layer" . $subtab['id_text'] . "')\"><img src=\"" . SMARTMEDIA_IMAGE_URL . '400d_lay_flechd.gif" width="10" height="11" alt="" border="0"></a>';
                    }
                } else {
                    $subtab['next']        = '&nbsp;';
                    $subtab['arrow_right'] = '&nbsp;';
